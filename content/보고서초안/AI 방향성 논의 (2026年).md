...
▸ 소개 자료 : <iframe src="[[mes2-operconsole.html]]" width="100%" height="500px" frameBorder="0"></iframe>
▸ 접속 경로 : [https://mes-test.seahbesteel.co.kr/mes2](https://mes-test.seahbesteel.co.kr/mes2)

<a href="https://mes-test.seahbesteel.co.kr/mes2" target="_blank">https://mes-test.seahbesteel.co.kr/mes2</a>


### **2. FlowCore MES - 레거시 화면 암묵지 문서화 도구**  
  
오래된 MES/ERP 화면은 코드만으로는 "왜 이렇게 만들었는지", "어떤 업무 맥락에서 쓰이는지" 파악이 어렵고, 이 지식은 담당자 개인에게만 남아 있는 경우가 많습니다. 

FlowCore MES는 화면을 선택하면 관련 소스와 DB 구조를 자동으로 수집해 AI가 분석하고, 사람이 읽을 수 있는 결과 문서로 정리해 팀의 자산으로 축적합니다.  
...
▸ 접속 경로 : 
<a href="http://172.17.40.215:8088/" target="_blank">http://172.17.40.215:8088/</a>
